...
require_once(dirname(__FILE__) . '/WxPayNotifyReply.php');
...
class WxPayNotify extends WxPayNotifyReply
{
    ...
    final public function Handle($config, $needSign = true)
    {
        ...
        $result = $this->CI->wechat_sdk->notify($config, array($this, 'NotifyCallBack'), $msg);
        if($result == false){
    ...
    final private function ReplyNotify($needSign = true)
    {
        ...
        $this->CI->wechat_sdk->replyNotify($xml);
    }
}