...
require_once(dirname(__FILE__) . '/WxPayDataBase.php');
...
class WxPayResults extends WxPayDataBase
{
     ...
     */
    public  function InitFromArray($config, $array, $noCheckSign = false)
    {
        $obj = new self();
        $obj->FromArray($array);
     ...
     */
    public  function Init($config, $xml)
    {
        $obj = new self();
        $obj->FromXml($xml);
        //失败则直接返回失败
